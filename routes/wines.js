            ...
            db.collection('wines', function(err, collection) {
                collection.findOne({
                    ...
                    if (item != null) {
                        ...
                        //req.app.settings.nodetime.metric('Custom Metrics', item.name, 1, null, 'inc');

                        //cache the wine retrieved from mongodb in redis for 10*60 secs
                        //uncomment the line below for lab 3.2
                        //redisClient.setex(id, 600, JSON.stringify(item));
